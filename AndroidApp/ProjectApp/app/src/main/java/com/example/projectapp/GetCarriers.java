...
public class GetCarriers extends AppCompatActivity {
    private TextView mJsonTxtView;
    TableDynamic tabla;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_carriers);
        tabla = new TableDynamic(this, (TableLayout)findViewById(R.id.tabla));
        String [] cabeza = {"ID","CI","Name","BirthDate","Phone","Mobile","Email","Address","TruckPlate","TruckType"};
